...
#include <arpa/inet.h>  // for sockaddr_in and inet_ntoa() -> Ensure that all the byte are most significant bit in leftmost position
...
int main( int argc, char *argv[] ) {
    ...
    // htons ensure that all the byte are most significant bit in leftmost position
